...
public class TravelPage extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {

    public static final String API_KEY = "AIzaSyAPPEuKa6rCH6kuysnIZaakqiYvB_Z53C4";
    public static String video_ID = "MD8U6QV7Pb8";
    private static final String[] CLASSES = new String[] {
            "Dubai", "New York", "Hawaii", "Egypt", "South Korea"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TravelPage.this, TravelReview.class);
