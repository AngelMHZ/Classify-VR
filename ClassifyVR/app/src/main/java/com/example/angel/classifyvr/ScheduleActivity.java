    ...
    public class LoadViewsInToWeekView extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                weekDatas.add(getWeekValues(String.valueOf(0), "12", "African Studies 100",
                ...
                weekDatas.add(getWeekValues(String.valueOf(2), "12", "The Lion King",
                        tapMargin, buttonHight));

                //** for tue day
                tapMargin = getWithAndHigthToButton(15);
                buttonHight = getHightOfButton(15, 19);
                weekDatas.add(getWeekValues(String.valueOf(2), "12", "Frat Football",
                        tapMargin, buttonHight));
                ...
                weekDatas.add(getWeekValues(String.valueOf(5), "12", "Dubai Club",
                        tapMargin, buttonHight));
        ...
        protected void onPreExecute() {
            try {
                ...
                dialog = ProgressDialog.show(ScheduleActivity.this, null, null,
                        true, false);
